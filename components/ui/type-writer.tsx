        ...
        <div className="relative w-full max-w-4xl mx-auto">
            ...
            >
                ...
                >
                    <span
                        data-typewriter
                        className="inline-block bg-clip-text text-transparent bg-gradient-to-b from-black to-black/70 dark:from-white dark:to-white/20 border-r-2 border-black dark:border-white animate-cursor pr-1 pt-3"
                    >
                        {sequences[0].text}
                    </span>
                </motion.div>
